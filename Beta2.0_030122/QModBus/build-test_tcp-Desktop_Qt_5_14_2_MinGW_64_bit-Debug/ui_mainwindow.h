...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(0, 40, 669, 100));
        ...
        menuCommunication->setGeometry(QRect(2405, 99, 136, 92));
