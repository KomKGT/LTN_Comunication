    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ui->actionMODBUS_TCP,&QAction::triggered,
            this,&MainWindow::device02_dialog_exec); //ต้องเปลี่ยนไปเรียกใช้ slot ของ device02_tcp เพื่อไปเปิด Dialog property ของ modbus tcp (เรียก slot นอก class)
...
void MainWindow::device02_dialog_exec()
{
    ...
    /*if(device02_mbTCP.is_connected())
        ...
        QMessageBox::information(this,"Device2 Not Connected","Device2 Not Connected");*/
    //device02_read_regs();
