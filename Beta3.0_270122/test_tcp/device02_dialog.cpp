...
QString Device02_dialog::IPV4_Selected()
{
    return  ui->IPv4_line_edit->text();
}

QString Device02_dialog::Slave_Selected()
{
    return ui->slave_line_edit->text();
}

QString Device02_dialog::Port_Selected()
{
    return ui->port_line_edit->text();
}

QString Device02_dialog::Reg_Selected()
{
    return ui->rd_reg_line_edit->text();
}

QString Device02_dialog::Count_Selected()
{
    return ui->rd_count_line_edit->text();
}

QString Device02_dialog::OkBTN()
{
