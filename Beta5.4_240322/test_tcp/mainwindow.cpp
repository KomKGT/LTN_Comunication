...
/****************************** File ACTION SECTION ********************************************/
    ...
    QPalette color_MeltTemp_LCD = ui->MeltTemp_LCD->palette();
    color_MeltTemp_LCD.setColor(QPalette::WindowText,Qt::green);
    //Pal.setColor(QPalette::Normal, QPalette::Window, Qt::black);
    ui->MeltTemp_LCD->setPalette(color_MeltTemp_LCD);
    //ui->MeltTemp_LCD->display("0");

    QPalette color_MeltPressure_LCD = ui->MeltPressure_LCD->palette();
    color_MeltPressure_LCD.setColor(QPalette::WindowText,Qt::green);
    //Pal.setColor(QPalette::Normal, QPalette::Window, Qt::black);
    ui->MeltPressure_LCD->setPalette(color_MeltPressure_LCD);
    //ui->MeltPressure_LCD->setPalette(Qt::green);
