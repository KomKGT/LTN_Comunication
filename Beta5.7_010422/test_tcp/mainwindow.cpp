...
void MainWindow::device01_read()
{
    ...
    double range_max = *max_element(v_maxValue.begin(), v_maxValue.end());
    double range_min = *min_element(v_minValue.begin(), v_minValue.end());
    ...
    */
    ...
    ui->plot->yAxis->setRange(range_min-1,range_max+50);
    ui->plot->yAxis2->setRange(range_min-1,range_max+5);
...
void MainWindow::openFile_dialog_exec()
{
    ...
    if(inputFile.open(QIODevice::ReadOnly))
    {
        ...
        double max_x  = *max_element(time.begin(), time.end());
        double P1_max = *max_element(v_y4.begin(), v_y4.end());
        double P1_min = *min_element(v_y4.begin(), v_y4.end());
        double P2_max = *max_element(v_y1.begin(), v_y1.end());
        double P2_min = *min_element(v_y1.begin(), v_y1.end());
        ...
        ui->plot->xAxis->setRange(0,max_x);
        ui->plot->yAxis->setRange(range_min-1,range_max+50);
        ui->plot->yAxis2->setRange(range_min-1,range_max+5);
